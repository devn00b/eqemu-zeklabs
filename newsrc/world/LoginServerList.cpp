...
void LoginServerList::Add(const char* iAddress, int16 iPort, const char* Account, const char* Password, bool remoteServer)
{
	LoginServer* loginserver = new LoginServer(iAddress, iPort, Account, Password, remoteServer);
