...
public:
	...
	enum ZONE_TYPES { ZONE_ALL, ZONE_STATIC=1, ZONE_BOOTED=2, ZONE_AVAILABLE=3 };
	...
	Timer*	shutdowntimer;
	Timer*	logtimer; // Kings & Bandits logtimer for tracking server stats
	Timer*	upkeeptimer; // Kings & Bandits upkeeptimer for handling upkeep on team cities
	Timer*	reminder;
	...
	uint32	GetZoneCount(ZONE_TYPES zoneType);
