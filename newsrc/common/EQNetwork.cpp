...
bool EQStreamServer::Open(char* inIPAddr, int16 iPort) {
...
//		int reuse_addr = 1;
	  ...
	  /* Setup internet address information.  
		...
		address.sin_addr.s_addr = inet_addr(inIPAddr);
...
//#endif
		...
		bool val = 1;
		//setsockopt ( m_Socket , SOL_SOCKET , SO_BROADCAST , (char*)&val , sizeof( val ) );
