...
#define ServerOP_PrivateLSStats		0x1010
#define ServerOP_StatAuth			0x1011
...
#define ServerOP_FTLocationUpdate		0x9001
#define ServerOP_FTRegionUpdate			0x9002
#define	ServerOP_FTIntervalUpdate		0x9003

#define ServerOP_Command				0x9090
#define ServerOP_PlayerCounts			0x9091
...
struct FTLocationControl_Struct {
	int32	locationID;
	int32	regionID;
	int32	guildID;
};

struct FTRegionControl_Struct {
	int32	regionID;
	int32	guildID;
};
...
struct PlayerInfo_Struct {
	...
	uint32 teamOneCount;
	uint32 teamTwoCount;
	uint32 teamThreeCount;
	uint32 teamFourCount;
	uint32 teamFiveCount;
};
...
enum CommandIDs {
	...
	RELOAD_HOTZONES,
	RELOAD_ZONE_QUESTS,
	CAST_SELF_ON_CLIENTS,
	UPDATE_CLIENT_LOSTLEADERSHIP,
	UPDATE_CLIENT_BANKREVENUE,
	UPDATE_CLIENT_GIVELEADERSHIP,
	UPDATE_CLIENT_SETBOUNTY,
	UPDATE_CITY_MOBS,
	RELOAD_PVPHOTZONES
};

struct ZoneStatusAuth_Struct {
	uint32	updateZoneID;
	uint32	updateInstanceID;
	uint32	staticZones;
	uint32	bootedZones;
	uint32	availZones;
	int32	commandID;
