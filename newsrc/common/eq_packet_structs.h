...
/*018*/	int32	player_id;	//'global' ID of the caster, for wearoff messages
/*020*/
};
...
/*006*/	int8 effect;
/*005*/	int8 level;
/*007*/	int8 bard_modifier;
/*004*/	int8 slot;
/*008*/	uint32 spellid;
/*012*/	uint32 duration;
/*016*/	uint32 counters;
/*020*/	uint32 player_id;	//prolly global player ID
/*024*/	uint32 slotid;
/*028*/	uint32 bufffade;
/*032*/
};

struct SpellBuffFadeOld_Struct {
/*000*/	uint32 entityid;
/*004*/	int8 slot;
/*005*/	int8 level;
/*006*/	int8 effect;
...
//Combat Abilities
struct DisarmAbility_Struct {
	int32 m_source;		//the ID of the source mob
	int32 m_target;		//the ID of the target mob
	int32 m_skill_level; // skill of the player (source) - confirmed via #setallskill 200 = C8
	int32 m_result;
};
...
struct TempMerchantList{
	...
	uint32	slot;
	uint32	item;
	sint32	charges; //charges/quantity
	uint32	origslot;
};
...
struct ShroudSelectionWindow
{
	...
	uint32 unknown2;
	char shroudSelectionTreeString[0];
};
...
struct QuestSound_Struct {
	/*000*/ uint32	entity_id;	// ID of mob awarding the client
...
struct Buffs_Struct {
	...
	int8	player_class; // class of player
