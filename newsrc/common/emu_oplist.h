...
N(OP_LoginRejected),
N(OP_Shroud),
N(OP_ShroudProgressionUpdate),
N(OP_ShroudBankEmpty),
N(OP_ShroudUnknown1),
N(OP_ShroudSelEquipDetail),
N(OP_ShroudClearAA),
N(OP_ShroudSelectionWindow),
N(OP_ShroudRequestStats),
N(OP_ClientBegin),
#ifdef LOGINCRYPTO
N(OP_Chat_ChannelList),
N(OP_ServerList),
N(OP_AllFinish),
N(OP_ChangePassword),
N(OP_Chat_SysMsg),
...
N(OP_Version),
#endif
// additional revived opcodes due to trilogy
N(OP_SetDataRate),
N(OP_CharItem),