...
bool LoadEMuShareMemDLL::Load() {
	...
	if (Loaded()) {
		...
		Items.GetItemNoConst = (DLLFUNC_GetItemNoConst) GetSym("GetItemNoConst");
		...
		RandomLootDrops.GetItem = (DLLFUNC_GetRandomLootDrop) GetSym("GetRandomLootDrop");
		RandomLootDrops.IterateItems = (DLLFUNC_IterateLootDrops) GetSym("IterateLootDrops");
		RandomLootDrops.cbAddRandomLootDrop = (DLLFUNC_AddRandomLootDrop) GetSym("AddRandomLootDrop");
		RandomLootDrops.DLLLoadRandomLootDrops = (DLLFUNC_DLLLoadRandomLootDrops) GetSym("DLLLoadRandomLootDrops");
		
		RandomDropRates.GetItem = (DLLFUNC_GetRandomDropRate) GetSym("GetRandomDropRate");
		RandomDropRates.cbAddRandomDropRate = (DLLFUNC_AddRandomDropRate) GetSym("AddRandomDropRate");
		RandomDropRates.DLLLoadRandomDropRates = (DLLFUNC_DLLLoadRandomDropRates) GetSym("DLLLoadRandomDropRates");
		
		RandomNameGroups.GetItem = (DLLFUNC_GetRandomNameGroup) GetSym("GetRandomNameGroup");
		RandomNameGroups.cbAddRandomNameGroup = (DLLFUNC_AddRandomNameGroup) GetSym("AddRandomNameGroup");
		RandomNameGroups.DLLLoadRandomNameGroups = (DLLFUNC_DLLLoadRandomNameGroups) GetSym("DLLLoadRandomNameGroups");
		
		ZoneNames.GetItem = (DLLFUNC_GetZoneName) GetSym("GetZoneName");
		ZoneNames.IterateZoneNames = (DLLFUNC_IterateZoneNames) GetSym("IterateZoneNames");
		ZoneNames.cbAddZoneName = (DLLFUNC_AddZoneName) GetSym("AddZoneName");
		ZoneNames.DLLLoadZoneNames = (DLLFUNC_DLLLoadZoneNames) GetSym("DLLLoadZoneNames");
		
		TeamSettings.GetTeamSettings = (DLLFUNC_GetTeamSettings) GetSym("GetTeamSettings");
		TeamSettings.cbAddTeamSettings = (DLLFUNC_AddTeamSettings) GetSym("AddTeamSettings");
		TeamSettings.cbUpdateTeamSettings = (DLLFUNC_UpdateTeamSettings) GetSym("UpdateTeamSettings");
		TeamSettings.DLLLoadTeamSettings = (DLLFUNC_DLLLoadTeamSettings) GetSym("DLLLoadTeamSettings");
		
		TeamSettings.cbUpdatePVPLeaderBoard = (DLLFUNC_UpdatePVPLeaderBoard) GetSym("UpdatePVPLeaderboard");
		TeamSettings.GetPVPLeadershipBoardByKills = (DLLFUNC_GetPVPLeadershipBoardByKills) GetSym("GetPVPLeadershipBoardByKills");
		TeamSettings.GetPVPLeadershipBoardByPoints = (DLLFUNC_GetPVPLeadershipBoardByPoints) GetSym("GetPVPLeadershipBoardByPoints");
		TeamSettings.GetPVPLeadershipBoardByInfamy = (DLLFUNC_GetPVPLeadershipBoardByPoints) GetSym("GetPVPLeadershipBoardByInfamy");
		
		TeamSettings.cbUpdateGuardSettings = (DLLFUNC_UpdateGuardSettings) GetSym("UpdateGuardSettings");
		TeamSettings.GetGuardSettings = (DLLFUNC_GetGuardSettings) GetSym("GetGuardSettings");
		TeamSettings.GetIsItemFound = (DLLFUNC_GetIsItemFound) GetSym("GetIsItemFound");
		
		TeamSettings.cbUpdateGuildHateList = (DLLFUNC_UpdateGuildHateList) GetSym("UpdateGuildHateList");
		TeamSettings.GetGuildHateList = (DLLFUNC_GetGuildHateList) GetSym("GetGuildHateList");
