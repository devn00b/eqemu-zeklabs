...
public:
	...
	virtual State_t	GetState(bool lockState=true) const;
	inline bool		Connected()	const	{ return (GetState() == TCPS_Connected); }
	bool		ConnectReady(bool lockState=true) const;
...
//	SOCKET			sock;
	...
	virtual void ClearBuffers(bool lockMState=true);
