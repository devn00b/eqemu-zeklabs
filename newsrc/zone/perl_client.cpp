...
XS(XS_Client_GetBindZoneID)
{
	dXSARGS;
	if (items != 1)
		Perl_croak(aTHX_ "Usage: Client::GetBindZoneID(THIS)");
	{
		Client *		THIS;
		uint32		RETVAL;
		dXSTARG;
		...
		RETVAL = THIS->GetBindZoneID();
		XSprePUSH; PUSHu((UV)RETVAL);
	}
	XSRETURN(1);
}

XS(XS_Client_GetIntoxication); /* prototype to pass -Wmissing-prototypes */
XS(XS_Client_GetIntoxication)
{
	dXSARGS;
	if (items != 1)
		Perl_croak(aTHX_ "Usage: Client::GetIntoxication(THIS)");
	{
		Client *		THIS;
		uint32		RETVAL;
		dXSTARG;
...
XS(XS_Client_SetAnon)
{
	dXSARGS;
	if (items != 2)
		Perl_croak(aTHX_ "Usage: Client::SetAnon(THIS, toggle)");
	{
		Client *		THIS;
		uint8		toggle =  (uint8)SvIV(ST(1));
		...
		THIS->SetAnon(toggle);
		THIS->SendAppearancePacket(AT_Anon, toggle);
	}
	XSRETURN_EMPTY;
}
...
XS(XS_Client_SetBindPoint)
{
	dXSARGS;
	if (items < 1 || items > 6)
		Perl_croak(aTHX_ "Usage: Client::SetBindPoint(THIS, to_zone= -1, new_x= 0.0f, new_y= 0.0f, new_z= 0.0f, zonepointCheck=true)");
	{
		Client *		THIS;
		int		to_zone;
		float		new_x;
		...
		if ( items < 6 )
			...
			zonepointCheck  = (bool)SvTRUE(ST(5));
			
		THIS->SetBindPoint(to_zone, new_x, new_y, new_z, zonepointCheck);
	}
	XSRETURN_EMPTY;
}
...
XS(XS_Client_AddToInstance); /* prototype to pass -Wmissing-prototypes */
XS(XS_Client_AddToInstance)
{
	dXSARGS;
	if (items != 2)
		Perl_croak(aTHX_ "Usage: Client::AddToInstance(THIS, instanceID)");
	{
		Client *		THIS;
		int32		instanceID = (int32)SvUV(ST(1));
		...
		database.AddClientToInstance(instanceID, THIS->CharacterID());
	}
	XSRETURN_EMPTY;
}

XS(XS_Client_CreateInstance); /* prototype to pass -Wmissing-prototypes */
XS(XS_Client_CreateInstance)
{
	dXSARGS;
	if (items != 4)
		Perl_croak(aTHX_ "Usage: Client::CreateInstance(THIS, zonename, version, duration)");
	{
		Client *		THIS;
		int32		RETVAL;
		dXSTARG;

		char*		zone = (char *)SvPV_nolen(ST(1));
		int16		version = (int32)SvUV(ST(2));
		int32		duration = (int32)SvUV(ST(3));
		if (sv_derived_from(ST(0), "Client")) {
			IV tmp = SvIV((SV*)SvRV(ST(0)));
			THIS = INT2PTR(Client *,tmp);
		}
		...
		if(zone_id != 0)
		{
			...
			{
				THIS->Message(13, "Server was unable to find a free instance id.");
			}
			else if(!database.CreateInstance(id, zone_id, version, duration))
			{
				THIS->Message(13, "Server was unable to create a new instance.");
			}
		}
		XSprePUSH; PUSHu((UV)id);
	}
	XSRETURN(1);
}
...
XS(XS_Client_IncreaseAllSkills); /* prototype to pass -Wmissing-prototypes */
XS(XS_Client_IncreaseAllSkills)
{
	dXSARGS;
	if (items < 2 )
		Perl_croak(aTHX_ "Usage: Client::IncreaseSkill(THIS, skills_value)");
	{
		Client *		THIS;
		...
		if(THIS == NULL)
			...
			int16 max = THIS->CastToClient()->GetMaxSkillAfterSpecializationRules(skill_num, THIS->CastToClient()->MaxSkill(skill_num));
			int16 actualValue = (int16)level;
			if ( actualValue > max )
				actualValue = max;
				THIS->CastToClient()->SetSkill(skill_num, actualValue);
			}
	}
	XSRETURN_EMPTY;
}
...
XS(XS_Client_NukeInventory); /* prototype to pass -Wmissing-prototypes */
XS(XS_Client_NukeInventory)
{
	dXSARGS;
	if (items != 1)
		Perl_croak(aTHX_ "Usage: Client::NukeInventory(THIS)");
	{
		Client *		THIS;
		dXSTARG;
...
XS(XS_Client_SetStartingItems); /* prototype to pass -Wmissing-prototypes */
XS(XS_Client_SetStartingItems)
{
	dXSARGS;
	if (items != 1)
		Perl_croak(aTHX_ "Usage: Client::SetStartingItems(THIS)");
	{
		Client *		THIS;
		dXSTARG;
...
XS(XS_Client_HasItem); /* prototype to pass -Wmissing-prototypes */
XS(XS_Client_HasItem)
{
	dXSARGS;
	if (items != 2)
		Perl_croak(aTHX_ "Usage: Client::HasItem(THIS, item_id)");
	{
		Client *		THIS;
		sint16		RETVAL;
		dXSTARG;
		int32		item_id = (uint32)SvUV(ST(1));
		...
		if(THIS == NULL)
			Perl_croak(aTHX_ "THIS is NULL, avoiding crash.");
		RETVAL = THIS->GetInv().HasItem(item_id);
		XSprePUSH; PUSHi((IV)RETVAL);
	}
	XSRETURN(1);
}
...
XS(XS_Client_PutItemInOpenSlot); /* prototype to pass -Wmissing-prototypes */
XS(XS_Client_PutItemInOpenSlot)
{
	dXSARGS;
	if (items < 2 || items > 9)
		Perl_croak(aTHX_ "Usage: Client::PutItemInOpenSlot(THIS, item_id, charges=0, attune=0, aug1=0, aug2=0, aug3=0, aug4=0, aug5=0)");
	{
		Client *		THIS;
		int32		item_id = (int32)SvUV(ST(1));
		sint32		charges = 0;
		bool		attune = false;
		int32		aug1 = 0;
		int32		aug2 = 0;
		...
		if (items > 2) {
			charges = (sint32)SvIV(ST(2));
		}
		if (items > 3) {
			attune = (bool)SvTRUE(ST(3));
		}
		if (items > 4) {
			aug1 = (int32)SvUV(ST(4));
		}
		if (items > 5) {
			aug2 = (int32)SvUV(ST(5));
		}
		if (items > 6) {
			aug3 = (int32)SvUV(ST(6));
		}
		if (items > 7) {
			aug4 = (int32)SvUV(ST(7));
		}
		if (items > 8) {
			aug5 = (int32)SvUV(ST(8));
		}

		THIS->PutItemInOpenSlot(item_id, charges, aug1, aug2, aug3, aug4, aug5);
	}
	XSRETURN_EMPTY;
}
...
XS(XS_Client_SummonLootGroup); /* prototype to pass -Wmissing-prototypes */
XS(XS_Client_SummonLootGroup)
{
	dXSARGS;
	if (items != 2)
		Perl_croak(aTHX_ "Usage: Client::SummonLootGroup(THIS, loot_group_id)");
	{
		Client *		THIS;
		uint32		item_id = (uint32)SvUV(ST(1));
		...
		char* npcName = "UNKNOWN";
		if ( THIS->GetTarget() != NULL && THIS->GetTarget()->IsNPC() )
			npcName = (char*)THIS->GetOrigName();
		if ( database.GenerateRandomLootGroupResult(&rlds, item_id, npcName, (char*)THIS->GetName()) )
		{
			for(int i=0;i<rlds.itemDropCount;i++)
			{
				uint32 inItemID = rlds.items[i].itemID;
				if ( inItemID > 0 )
					THIS->SummonItem(inItemID,0,0,0,0,0,0,false,SLOT_CURSOR,true);
			}

			THIS->AddMoneyToPP(rlds.coinDropValue,true);
		}
		else
			Perl_croak(aTHX_ "Failed to generate RandomLootGroupResult Struct.");
	}
	XSRETURN_EMPTY;
}


XS(XS_Client_SetPVPValue); /* prototype to pass -Wmissing-prototypes */
XS(XS_Client_SetPVPValue)
{
	dXSARGS;
	if (items != 2)
		Perl_croak(aTHX_ "Usage: Client::SetPVPValue(THIS, value)");
	{
		Client *		THIS;
		uint8 pvpvalue = (uint8)SvUV(ST(1));
		...
		THIS->SetPVP(pvpvalue);
	}
	XSRETURN_EMPTY;
}


XS(XS_Client_GetPVPFlag); /* prototype to pass -Wmissing-prototypes */
XS(XS_Client_GetPVPFlag)
{
	dXSARGS;
	if (items != 1)
		Perl_croak(aTHX_ "Usage: Client::GetPVPFlag(THIS)");
	{
		Client *		THIS;
		int32		RETVAL;
		dXSTARG;
...
XS(XS_Client_SetIsKing); /* prototype to pass -Wmissing-prototypes */
XS(XS_Client_SetIsKing)
{
	dXSARGS;
	if (items != 2)
		Perl_croak(aTHX_ "Usage: Client::SetIsKing(THIS, value)");
	{
		Client *		THIS;
		uint8 value = (uint8)SvUV(ST(1));
		...
		THIS->SetIsKing(value);
	}
	XSRETURN_EMPTY;
}

XS(XS_Client_IsKing); /* prototype to pass -Wmissing-prototypes */
XS(XS_Client_IsKing)
{
	dXSARGS;
	if (items != 1)
		Perl_croak(aTHX_ "Usage: Client::IsKing(THIS)");
	{
		Client *		THIS;
		int32		RETVAL;
		dXSTARG;
...
XS(XS_Client_PlayMP3)
{
	dXSARGS;
	if (items != 2)
		Perl_croak(aTHX_ "Usage: Client::PlayMP3(THIS, value)");
	{
		Client *		THIS;
...
XS(XS_Client_AddPVPPoints)
{
		...
		Perl_croak(aTHX_ "Usage: Client::AddPVPPoints(THIS, Points)");
	{
		...
		RETVAL = THIS->AddPVPPoints(Points);
		ST(0) = boolSV(RETVAL);
		sv_2mortal(ST(0));
	}
	XSRETURN(1);
...
XS(XS_Client_SetPVPPoints);
XS(XS_Client_SetPVPPoints)
{
	dXSARGS;
	if (items != 2)
		Perl_croak(aTHX_ "Usage: Client::SetPVPPoints(THIS, Points)");
	{
		Client *	THIS;
		uint32		Points = (uint32)SvUV(ST(1));
...
XS(XS_Client_GetPVPKills); /* prototype to pass -Wmissing-prototypes */
XS(XS_Client_GetPVPKills)
{
	dXSARGS;
	if (items != 1)
		Perl_croak(aTHX_ "Usage: Client::GetPVPKills(THIS)");
	{
		Client *		THIS;
		int32		RETVAL;
		dXSTARG;
...
XS(XS_Client_GetPVPDeaths); /* prototype to pass -Wmissing-prototypes */
XS(XS_Client_GetPVPDeaths)
{
	dXSARGS;
	if (items != 1)
		Perl_croak(aTHX_ "Usage: Client::GetPVPDeaths(THIS)");
	{
		Client *		THIS;
		int32		RETVAL;
		dXSTARG;
		...
		RETVAL = THIS->GetPVPDeaths();
		XSprePUSH; PUSHu((UV)RETVAL);
	}
	XSRETURN(1);
}

XS(XS_Client_GetPVPCareerPoints); /* prototype to pass -Wmissing-prototypes */
XS(XS_Client_GetPVPCareerPoints)
{
	dXSARGS;
	if (items != 1)
		Perl_croak(aTHX_ "Usage: Client::GetPVPCareerPoints(THIS)");
	{
		Client *		THIS;
		int32		RETVAL;
		dXSTARG;
		...
		RETVAL = THIS->GetPVPCareerPoints();
		XSprePUSH; PUSHu((UV)RETVAL);
	}
	XSRETURN(1);
}
...
XS(XS_Client_GetBestKillStreak); /* prototype to pass -Wmissing-prototypes */
XS(XS_Client_GetBestKillStreak)
{
	dXSARGS;
	if (items != 1)
		Perl_croak(aTHX_ "Usage: Client::GetBestKillStreak(THIS)");
	{
		Client *		THIS;
		int32		RETVAL;
		dXSTARG;
...
XS(XS_Client_GetWorstDeathStreak); /* prototype to pass -Wmissing-prototypes */
XS(XS_Client_GetWorstDeathStreak)
{
	dXSARGS;
	if (items != 1)
		Perl_croak(aTHX_ "Usage: Client::GetWorstDeathStreak(THIS)");
	{
		Client *		THIS;
		int32		RETVAL;
		dXSTARG;
		...
		RETVAL = THIS->GetWorstDeathStreak();
		XSprePUSH; PUSHu((UV)RETVAL);
	}
	XSRETURN(1);
}
...
XS(XS_Client_GetCurrentKillStreak); /* prototype to pass -Wmissing-prototypes */
XS(XS_Client_GetCurrentKillStreak)
{
	dXSARGS;
	if (items != 1)
		Perl_croak(aTHX_ "Usage: Client::GetCurrentKillStreak(THIS)");
	{
		Client *		THIS;
		int32		RETVAL;
		dXSTARG;
		...
		RETVAL = THIS->GetCurrentKillStreak();
		XSprePUSH; PUSHu((UV)RETVAL);
	}
	XSRETURN(1);
}
...
XS(XS_Client_GetInfamy); /* prototype to pass -Wmissing-prototypes */
XS(XS_Client_GetInfamy)
{
	dXSARGS;
	if (items != 1)
		Perl_croak(aTHX_ "Usage: Client::GetInfamy(THIS)");
	{
		Client *		THIS;
		int32		RETVAL;
		dXSTARG;
...
XS(XS_Client_IsBountySet); /* prototype to pass -Wmissing-prototypes */
XS(XS_Client_IsBountySet)
{
	dXSARGS;
	if (items != 1)
		Perl_croak(aTHX_ "Usage: Client::IsBountySet(THIS)");
	{
		Client *		THIS;
		bool		RETVAL;
...
XS(XS_Client_LoadCharacterLevelUpdates); /* prototype to pass -Wmissing-prototypes */
XS(XS_Client_LoadCharacterLevelUpdates)
{
	dXSARGS;
	if (items != 2)
		Perl_croak(aTHX_ "Usage: Client::LoadCharacterLevelUpdates(THIS, baselevel)");
	{
		Client *		THIS;
		uint32		baselvl = (uint32)SvUV(ST(1));
		...
		THIS->LoadCharacterLevelUpdates(baselvl);
	}
	XSRETURN_EMPTY;
}
...
XS(boot_Client)
{
	...
	XS_VERSION_BOOTCHECK ;
		...
		newXSproto(strcpy(buf, "GetIntoxication"), XS_Client_GetIntoxication, file, "$");
		...
		newXSproto(strcpy(buf, "AddToInstance"), XS_Client_AddToInstance, file, "$$");
		newXSproto(strcpy(buf, "CreateInstance"), XS_Client_CreateInstance, file, "$$$$");
		...
		newXSproto(strcpy(buf, "IncreaseAllSkills"), XS_Client_IncreaseAllSkills, file, "$$");
		...
		newXSproto(strcpy(buf, "NukeInventory"), XS_Client_NukeInventory, file, "$");
		newXSproto(strcpy(buf, "SetStartingItems"), XS_Client_SetStartingItems, file, "$");
		...
		newXSproto(strcpy(buf, "HasItem"), XS_Client_HasItem, file, "$$");
		...
		newXSproto(strcpy(buf, "PutItemInOpenSlot"), XS_Client_PutItemInOpenSlot, file, "$$;$$$$$$$");
		
		// Kings & Bandits perl client additions
		newXSproto(strcpy(buf, "SummonLootGroup"), XS_Client_SummonLootGroup, file, "$$");
		newXSproto(strcpy(buf, "SetPVPValue"), XS_Client_SetPVPValue, file, "$$");
		newXSproto(strcpy(buf, "GetPVPFlag"), XS_Client_GetPVPFlag, file, "$");
		newXSproto(strcpy(buf, "SetIsKing"), XS_Client_SetIsKing, file, "$$");
		newXSproto(strcpy(buf, "IsKing"), XS_Client_IsKing, file, "$");
		...
		newXSproto(strcpy(buf, "SetPVPPoints"), XS_Client_SetPVPPoints, file, "$$");
		newXSproto(strcpy(buf, "AddCrystals"), XS_Client_AddCrystals, file, "$$");
		newXSproto(strcpy(buf, "GetPVPKills"), XS_Client_GetPVPKills, file, "$");
		newXSproto(strcpy(buf, "GetPVPDeaths"), XS_Client_GetPVPDeaths, file, "$");
		newXSproto(strcpy(buf, "GetPVPCareerPoints"), XS_Client_GetPVPCareerPoints, file, "$");
		newXSproto(strcpy(buf, "GetBestKillStreak"), XS_Client_GetBestKillStreak, file, "$");
		newXSproto(strcpy(buf, "GetCurrentKillStreak"), XS_Client_GetCurrentKillStreak, file, "$");
		newXSproto(strcpy(buf, "GetPVPPoints"), XS_Client_GetPVPPoints, file, "$");
		newXSproto(strcpy(buf, "GetInfamy"), XS_Client_GetInfamy, file, "$");
		newXSproto(strcpy(buf, "IsBountySet"), XS_Client_IsBountySet, file, "$");
		...
		newXSproto(strcpy(buf, "LoadCharacterLevelUpdates"), XS_Client_LoadCharacterLevelUpdates, file, "$$");
	XSRETURN_YES;
}
