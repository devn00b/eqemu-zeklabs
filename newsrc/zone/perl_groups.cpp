...
XS(XS_Group_AddToInstance); /* prototype to pass -Wmissing-prototypes */
XS(XS_Group_AddToInstance)
{
	dXSARGS;
	if (items != 2)
		Perl_croak(aTHX_ "Usage: Group::AddToInstance(THIS, instance_id)");
	{
		Group *		THIS;
		uint32		instance_id = (uint32)SvUV(ST(1));
...
XS(boot_Group)
{
	...
	XS_VERSION_BOOTCHECK ;
		...
		newXSproto(strcpy(buf, "AddToInstance"), XS_Group_AddToInstance, file, "$$");
