...
public:
	...
	virtual void Damage(Mob* from, sint32 damage, int16 spell_id, SkillType attack_skill, bool avoidable = true, sint8 buffslot = -1, bool iBuffTic = false, bool isDmgShield = false, bool isCritHit = false);
