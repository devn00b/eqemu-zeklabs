...
//	virtual bool IsGroup()			const { return false; }
	...
	virtual bool IsShroudNPC()		const { return false; }
...
//	void	SendGuildJoin(GuildJoin_Struct* gj);
	...
	NPC*	FindNearbyNPC(float x, float y, float z, float radius, NPC* originator);
...
//	Entity*	GetEntityGroup(int32 id);
	...
	void    QueueClients(Mob* sender, const EQApplicationPacket* app, bool ignore_sender=false, bool ackreq = true, bool posUpdates=false);
	...
	void	AESpell(Mob *caster, Mob *center, int16 spell_id, bool affect_caster = true, sint16 resist_adjust = 0, bool clientOnly=false);
	...
	void    RemoveFromPlayerPetHateLists(Mob* mob, bool settoone = false);
	...
	void ListGroundSpawns(Client* c);
protected:
	friend class Zone;
