...
public:
	...
	Corpse(NPC* in_npc, ItemList* in_itemlist, int32 in_npctypeid, const NPCType** in_npctypedata, int32 in_decaytime = 600000, bool overrideDecay=false);
	Corpse(Client* client, sint32 in_rezexp, bool dropItems=false);
	...
	virtual void Death(Mob* killerMob, sint32 damage, int16 spell_id, SkillType attack_skill, int32 player_id=0) { return; }
	virtual void Damage(Mob* from, sint32 damage, int16 spell_id, SkillType attack_skill, uint8 itemType, bool avoidable = true, sint8 buffslot = -1, bool iBuffTic = false, bool isDamageShield=false, bool isCritHit = false, int32 player_id=0, bool isDoT=false) { return; }
	...
	inline int32	IsLootedBy() { return BeingLootedBy; }
	...
	void RandomItemToCorpse(Client *client);
protected:
