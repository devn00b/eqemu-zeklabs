...
{
public:
	SpawnGroup(uint32 in_id, char* name, int in_group_spawn_limit, float dist, float maxx, float minx, float maxy, float miny, int delay_in );
	~SpawnGroup();
	uint32 GetNPCType(int32 deathcount=0);
