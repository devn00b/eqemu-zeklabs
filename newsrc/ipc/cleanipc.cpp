...
int main(int argc, char** argv) {
	...
	memuser_ds->shm_nattch = 0;
		...
		switch (i) {
			...
			case 1: shm_key = ftok(".", 'X'); n="unused"/*npc_types*/; break;
			...
			case 8: shm_key = ftok(".", 'K'); n="skillcaps"; break;
			case 9: shm_key = ftok(".", 'A'); n="Arandlootdrops"; break;
			case 10: shm_key = ftok(".", 'B'); n="Aranddroprates"; break;
			case 11: shm_key = ftok(".", 'R'); n="Arandnamegroups"; break;
			case 12: shm_key = ftok(".", 'Z'); n="zonenames"; break;
			case 13: shm_key = ftok(".", 'T'); n="teamsettings"; break;
			case 14: shm_key = ftok(".", 'X'); n="tradeskills"; break;
			default: break;
		}
