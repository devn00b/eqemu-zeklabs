...
sub EVENT_ITEM
{
 if(plugin::check_handin(\%itemcount, 5818 => 1, 2463 => 1, 12268 => 1))
  {
   quest::say("Ahahaha! You did it! You really did it! You Really did it!!! Now Listen close! Take this torch and touch the firepot and away you go!");
   quest::say("I have heard rumors of somone once using this same torch to travel between Neriak and Lesser Faydark but never had a chance to try it myself!");
