...
if($text=~/status/i){
$hp = quest::getguardfield(1,2106, "hp");
$mana = quest::getguardfield(1,2106, "mana");
$hpregen = quest::getguardfield(1,2106, "hpregen");
$manaregen = quest::getguardfield(1,2106, "manaregen");
$levels = quest::getguardfield(1,2106, "level");
$ac = quest::getguardfield(1,2106, "ac");
...
quest::resetguardfields(1,2106);
}

sub EVENT_SPAWN
{
	quest::loadguardtype(1,2106);
}