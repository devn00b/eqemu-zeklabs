...
if($text=~/status/i){
$hp = quest::getguardfield(1,2116, "hp");
$mana = quest::getguardfield(1,2116, "mana");
$hpregen = quest::getguardfield(1,2116, "hpregen");
$manaregen = quest::getguardfield(1,2116, "manaregen");
$levels = quest::getguardfield(1,2116, "level");
$ac = quest::getguardfield(1,2116, "ac");
...
quest::resetguardfields(1,2116);
}

sub EVENT_SPAWN
{
	quest::loadguardtype(1,2116);
}