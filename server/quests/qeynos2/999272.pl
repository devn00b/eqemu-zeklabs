...
if($text=~/status/i){
$hp = quest::getguardfield(1,999272, "hp");
$mana = quest::getguardfield(1,999272, "mana");
$hpregen = quest::getguardfield(1,999272, "hpregen");
$manaregen = quest::getguardfield(1,999272, "manaregen");
$levels = quest::getguardfield(1,999272, "level");
$ac = quest::getguardfield(1,999272, "ac");
...
quest::resetguardfields(1,999272);
}

sub EVENT_SPAWN
{
	quest::loadguardtype(1,999272);
}