...
if($text=~/status/i){
$hp = quest::getguardfield(1, 2113, "hp");
$mana = quest::getguardfield(1, 2113, "mana");
$hpregen = quest::getguardfield(1, 2113, "hpregen");
$manaregen = quest::getguardfield(1, 2113, "manaregen");
$levels = quest::getguardfield(1, 2113, "level");
$ac = quest::getguardfield(1, 2113, "ac");
...
quest::resetguardfields(1, 2113);
}

sub EVENT_SPAWN
{
	quest::loadguardtype(1, 2113);
}