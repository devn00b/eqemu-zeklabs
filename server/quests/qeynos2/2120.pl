...
if($text=~/status/i){
$hp = quest::getguardfield(1,2120, "hp");
$mana = quest::getguardfield(1,2120, "mana");
$hpregen = quest::getguardfield(1,2120, "hpregen");
$manaregen = quest::getguardfield(1,2120, "manaregen");
$levels = quest::getguardfield(1,2120, "level");
$ac = quest::getguardfield(1,2120, "ac");
...
quest::resetguardfields(1,2120);
}

sub EVENT_SPAWN
{
	quest::loadguardtype(1,2120);
}