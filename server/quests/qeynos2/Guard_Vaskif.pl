...
if($text=~/status/i){
$hp = quest::getguardfield(1, 2115, "hp");
$mana = quest::getguardfield(1, 2115, "mana");
$hpregen = quest::getguardfield(1, 2115, "hpregen");
$manaregen = quest::getguardfield(1, 2115, "manaregen");
$levels = quest::getguardfield(1, 2115, "level");
$ac = quest::getguardfield(1, 2115, "ac");
...
quest::resetguardfields(1, 2115);
}

sub EVENT_SPAWN
{
	quest::loadguardtype(1, 2115);
}