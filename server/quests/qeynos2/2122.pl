...
if($text=~/status/i){
$hp = quest::getguardfield(1,2122, "hp");
$mana = quest::getguardfield(1,2122, "mana");
$hpregen = quest::getguardfield(1,2122, "hpregen");
$manaregen = quest::getguardfield(1,2122, "manaregen");
$levels = quest::getguardfield(1,2122, "level");
$ac = quest::getguardfield(1,2122, "ac");
...
quest::resetguardfields(1,2122);
}

sub EVENT_SPAWN
{
	quest::loadguardtype(1,2122);
}