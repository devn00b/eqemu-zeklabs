...
if($text=~/status/i){
$hp = quest::getguardfield(3,9106, "hp");
$mana = quest::getguardfield(3,9106, "mana");
$hpregen = quest::getguardfield(3,9106, "hpregen");
$manaregen = quest::getguardfield(3,9106, "manaregen");
$levels = quest::getguardfield(3,9106, "level");
$ac = quest::getguardfield(3,9106, "ac");
...
quest::resetguardfields(3,9106);
}

sub EVENT_SPAWN
{
	quest::loadguardtype(3,9106);
}