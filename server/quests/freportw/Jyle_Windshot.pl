...
# if($text =~ /I am looking 'for' treant wood/i && $class == 'Ranger')
# {
# quest::say("You are a new courier from the Faydarks. I am sorry I did not stay closer to the docks. I hear that part of Freeport is d$
# }
...
{
 # Small Lantern ID-13003
 if($itemcount{13003} >= 1 && $class=='Ranger')
        {
