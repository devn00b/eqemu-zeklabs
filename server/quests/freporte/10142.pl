...
if($text=~/status/i){
$hp = quest::getguardfield(3,10142, "hp");
$mana = quest::getguardfield(3,10142, "mana");
$hpregen = quest::getguardfield(3,10142, "hpregen");
$manaregen = quest::getguardfield(3,10142, "manaregen");
$levels = quest::getguardfield(3,10142, "level");
$ac = quest::getguardfield(3,10142, "ac");
...
quest::resetguardfields(3,10142);
}

sub EVENT_SPAWN
{
	quest::loadguardtype(3,10142);
}