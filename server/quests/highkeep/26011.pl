...
sub EVENT_SAY { 
if($text=~/Hail/i){
quest::say("Welcome to my Casino! If you would like to try your luck at a game of chance, I can offer you a game of devn00b's Court. To play, buy a token from me, for points, or for cash from Table Dancer. Then just hand it 
to me when ready."); 
