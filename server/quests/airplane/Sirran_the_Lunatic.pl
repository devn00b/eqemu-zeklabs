...
sub EVENT_SAY {
  ...
  if($text=~/llaw eht htiw eno I ma/i) { #island6
    quest::say("Kcul doog! Ouy rof ydaer si erips eht fo retsis eht won, sdik boj doog.");
    quest::spawn2(71076,0,0,-927.4,-1033.2,1092.5,66.1,0); #x,y,z of her spawn needs to be tuned to match live more closely
  }
