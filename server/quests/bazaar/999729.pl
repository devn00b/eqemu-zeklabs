...
#$whatprize = 1;
	...
	##epic code test
         #epics
        if (($class eq  'Bard') && ($class ne 'Warrior' && $class ne 'Rogue' && $class ne 'Monk' && $class ne 'Berserker' && $class ne 'Shadowknight' && $class ne 'Paladin' && $class ne 'Ranger' && $class ne 'Magician' && $class ne 'Necromancer' && $class ne 'Enchanter' && $class ne 'wizard' && $class ne 'Cleric' && $class ne 'Druid' && $class ne 'Shaman') ) {
        ...
        elsif (($class eq  'Cleric')  && ($class ne 'Warrior' && $class ne 'Rogue' && $class ne 'Monk' && $class ne 'Berserker' && $class ne 'Shadowknight' && $class ne 'Paladin' && $class ne 'Ranger' && $class ne 'Magician' && $class ne 'Necromancer' && $class ne 'Enchanter' && $class ne 'Wizard' && $class ne 'Bard' && $class ne 'Druid' && $class ne 'Shaman') ) {
...
return;
        ...
        elsif (($class eq  'Druid')  && ($class ne 'Warrior' && $class ne 'Rogue' && $class ne 'Monk' && $class ne 'Berserker' && $class ne 'Shadowknight' && $class ne 'Paladin' && $class ne 'Ranger' && $class ne 'Magician' && $class ne 'Necromancer' && $class ne 'Enchanter' && $class ne 'Wizard' && $class ne 'Bard' && $class ne 'Cleric' && $class ne 'Shaman') ) {
...
return;
        ...
        elsif (($class eq  'Enchanter')   && ($class ne 'Warrior' && $class ne 'Rogue' && $class ne 'Monk' && $class ne 'Berserker' && $class ne 'Shadowknight' && $class ne 'Paladin' && $class ne 'Ranger' && $class ne 'Magician' && $class ne 'Necromancer' && $class ne 'Wizard' && $class ne 'Bard' && $class ne 'Druid' && $class ne 'Shaman') ) {
...
return;
        ...
        elsif (($class eq  'Magician')  && ($class ne 'Warrior' && $class ne 'Rogue' && $class ne 'Monk' && $class ne 'Shadowknight' && $class ne 'Paladin' && $class ne 'Ranger' && $class ne 'Necromancer' && $class ne 'Enchanter' && $class ne 'Wizard' && $class ne 'Bard' && $class ne 'Druid' && $class ne 'Shaman' && $class ne 'Cleric')  ) {
...
return;
        ...
        elsif (($class eq  'Monk')&& ($class ne 'Warrior' && $class ne 'Rogue' && $class ne 'Berserker' && $class ne 'Shadowknight' && $class ne 'Paladin' && $class ne 'Ranger' && $class ne 'Magician' && $class ne 'Necromancer' && $class ne 'Enchanter' && $class ne 'Wizard' && $class ne 'Bard' && $class ne 'Druid' && $class ne 'Shaman' && $class ne 'Cleric' ) ) {
...
return;
        ...
        elsif (($class eq  'Necromancer') && ($class ne 'Warrior' && $class ne 'Rogue' && $class ne 'Monk' && $class ne 'Berserker' && $class ne 'Shadowknight' && $class ne 'Paladin' && $class ne 'Ranger' && $class ne 'Magician' && $class ne 'Enchanter' && $class ne 'Wizard' && $class ne 'Bard' && $class ne 'Druid' && $class ne 'Shaman' && $class ne 'Cleric') ) {
...
return;
        ...
        elsif (($class eq  'Paladin') && ($class ne 'Warrior' && $class ne 'Rogue' && $class ne 'Monk' && $class ne 'Berserker' && $class ne 'Shadowknight' && $class ne 'Ranger' && $class ne 'Magician' && $class ne 'Necromancer' && $class ne 'Enchanter' && $class ne 'Wizard' && $class ne 'Bard' && $class ne 'Druid' && $class ne 'Shaman' && $class ne 'Cleric') ) {
...
return;
        ...
        elsif (($class eq  'Ranger') && ($class ne 'Warrior' && $class ne 'Rogue' && $class ne 'Monk' && $class ne 'Shadowknight' && $class ne 'Paladin' && $class ne 'Magician' && $class ne 'Necromancer' && $class ne 'Enchanter' && $class ne 'Wizard' && $class ne 'Bard' && $class ne 'Druid' && $class ne 'Shaman' && $class ne 'Cleric' ) ){
...
return;
        ...
        elsif (($class eq  'Rogue')&& ($class ne 'Warrior' && $class ne 'Monk' && $class ne 'Berserker' && $class ne 'Shadowknight' && $class ne 'Paladin' && $class ne 'Ranger' && $class ne 'Magician' && $class ne 'Necromancer' && $class ne 'Enchanter' && $class ne 'Wizard' && $class ne 'Bard' && $class ne 'Druid' && $class ne 'Shaman' && $class ne 'Cleric')) {
        ...
        elsif (($class eq  'Shadowknight') && ($class ne 'Warrior' && $class ne 'Rogue' && $class ne 'Monk' && $class ne 'Paladin' && $class ne 'Ranger' && $class ne 'Magician' && $class ne 'Necromancer' && $class ne 'Enchanter' && $class ne 'Wizard' && $class ne 'Bard' && $class ne 'Druid' && $class ne 'Shaman' && $class ne 'Cleric')) {
        ...
        elsif (($class eq  'Shaman')&& ($class ne 'Warrior' && $class ne 'Rogue' && $class ne 'Monk' && $class ne 'Berserker' && $class ne 'Shadowknight' && $class ne 'Paladin' && $class ne 'Ranger' && $class ne 'Magician' && $class ne 'Necromancer' && $class ne 'Enchanter' && $class ne 'Wizard' && $class ne 'Bard' && $class ne 'Druid' && $class ne 'Cleric')) {
        ...
        elsif (($class eq  'Warrior') && ($class ne 'Rogue' && $class ne 'Monk' && $class ne 'Berserker' && $class ne 'Shadowknight' && $class ne 'Paladin' && $class ne 'Ranger' && $class ne 'Magician' && $class ne 'Necromancer' && $class ne 'Enchanter' && $class ne 'Wizard' && $class ne 'Bard' && $class ne 'Druid' && $class ne 'Shaman' && $class ne 'Cleric')) {
        ...
        elsif (($class eq  'Wizard')&& ($class ne 'Warrior' && $class ne 'Rogue' && $class ne 'Monk' && $class ne 'Berserker' && $class ne 'Shadowknight' && $class ne 'Paladin' && $class ne 'Ranger' && $class ne 'Magician' && $class ne 'Necromancer' && $class ne 'Enchanter' && $class ne 'Bard' && $class ne 'Druid' && $class ne 'Shaman' && $class ne 'Cleric')) {
    ...
    if($whatprize >=70) {
		...
		if ($class eq  'Bard') {
            ...
            $whatprize = int(rand(100));
            if ($whatprize > 50) {
                $prze = quest::ChooseRandom(145546,145377,146282,146283,132844,145377,4571,4572,6686,4573,4574,4575,4576,4577,144117,47012,1622,2736,4315,64193,31851,31852,31853,31854,31855,31856,31857,31858,31859,31860,31861,31862,31863,132845,27810,30367,21935,141320,144922,11911,145241,145349,145350,145351,17799,141321,32557,145377);
            ...
            $whatprize = int(rand(100));
            if ($whatprize > 50) {
                $prze = quest::ChooseRandom(145547,145377,145367,147662,132844,145377,146282,146283,1641,1644,1648,1649,6686,1650,1651,1652,144117,47012,1622,2736,4315,64193,31851,31852,31853,31854,31855,31856,31857,31858,31859,31860,31861,31862,31863,132845,27810,30367,21935,141320,144922,11911,145241,145349,145350,145351,17799,141321,32557,145377);
				$winning =  quest::varlink($prze);
