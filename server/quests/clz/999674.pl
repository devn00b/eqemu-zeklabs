...
if($ulevel > 39 and $ulevel <45) {
quest::summonitem(52723);
quest::summonitem(52723);

quest::say("Please $name, Take this weapon and enjoy! Its one of the best I've found yet!");
}else{

#$togive = quest::ChooseRandom(77508,52882,52797,77509);
quest::summonitem(77508);
quest::summonitem(77508);
quest::say("Enjoy $name! These are master class items!");
}
}
}
