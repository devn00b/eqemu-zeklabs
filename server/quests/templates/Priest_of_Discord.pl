...
sub EVENT_SAY {
  if($text=~/hail/i) {
    quest::say("Ah, another who admits that the path to glory and power lies in discord? Have we not always preached the truth? If you wish to know more about this travel, I will tell you but thats not why you are here is it? You have come to seek the way of Discord in your life, then why dont you ask me about your [Tome] of Order and Discord.");
  }
#  if($text=~/know more/i) {
...
#    quest::pvp("on");
    quest::say("You really should go visit my cousin the Priest of Order in nexus They can help you");
    quest::ding();
  }
