...
sub EVENT_ITEM {
  ...
  if(plugin::check_handin(\%itemcount, 18099 => 1) && $faction >= 7) {
  ...
  if(plugin::check_handin(\%itemcount, 14365 => 1) && $faction >= 14) {
  ...
  if(plugin::check_handin(\%itemcount, 14382 => 1) && $faction >= 21) {
  ...
  if(plugin::check_handin(\%itemcount, 11609 => 1, 5430 => 1, 14366 => 1) && $faction >= 35) {
