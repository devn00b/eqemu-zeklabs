...
if($class ne 'Enchanter' && $class ne 'Necromancer' && $class ne 'Magician' && $class ne 'Wizard') {
...
if($text=~/sure/i) {
  	...
  	$interestedLink3 = quest::saylink("Brain of the Ishva Mal");
...
if($text=~/Brain of the Ishva Mal/i) {
  	quest::say("Brains...I need Brains....Bring me the Brain of the Ishva Mal in Paw.");
  }
...
sub EVENT_ITEM {
  ...
  if (plugin::check_handin(\%itemcount, 11622 => 1, 11602 => 1, 14111 => 1, 31161 => 1)) { # 
...
if($class eq 'Enchanter') {
    ...
    quest::ding();
    quest::exp("1000");
    quest::summonitem("10650"); # Celestial fists or whtever
...
if($class eq 'Magician') {
    ...
    quest::ding();
    quest::exp("1000");
    quest::summonitem("28034"); # Celestial fists or whtever
    return;
  }  
...
if($class eq 'Wizard') {
    ...
    quest::ding();
    quest::exp("1000");
    quest::summonitem("14341"); # Celestial fists or whtever
    return;
  }  
}
