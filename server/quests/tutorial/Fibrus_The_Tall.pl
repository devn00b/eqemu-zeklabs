...
quest::say("A special prize just for you!");
 ...
 #stat food x20
elsif($itemcount{64193} && $random_result>600 && $random_result<1300){  
quest::summonitem(quest::ChooseRandom(66602,66603,66601),20);
quest::say("Congrats!");

 }
#gems and cash
elsif($itemcount{64193} && $random_result>1300 && $random_result<1900){  
quest::summonitem(quest::ChooseRandom(10037,22503,10032,21823,21822,21821,21820));
quest::say("Congrats!");

 }
#fireworks
elsif($itemcount{64193} && $random_result>1900 && $random_result<2400){  
quest::summonitem(16880,16877,16879,16881,69230,69231,69233,69232,69234);
quest::say("Congrats!");

 }
 #potions
elsif($itemcount{64193} && $random_result>2400 && $random_result<2800){  
...
elsif($itemcount{64193} && $random_result>2800 && $random_result<3000){  
