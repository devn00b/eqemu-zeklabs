...
if($text=~/status/i){
$hp = quest::getguardfield(1, 4141, "hp");
$mana = quest::getguardfield(1, 4141, "mana");
$hpregen = quest::getguardfield(1, 4141, "hpregen");
$manaregen = quest::getguardfield(1, 4141, "manaregen");
$levels = quest::getguardfield(1, 4141, "level");
$ac = quest::getguardfield(1, 4141, "ac");
...
quest::resetguardfields(1, 4141);
}

sub EVENT_SPAWN
{
	quest::loadguardtype(1, 4141);
}