...
if($text=~/status/i){
$hp = quest::getguardfield(1,4068, "hp");
$mana = quest::getguardfield(1,4068, "mana");
$hpregen = quest::getguardfield(1,4068, "hpregen");
$manaregen = quest::getguardfield(1,4068, "manaregen");
$levels = quest::getguardfield(1,4068, "level");
$ac = quest::getguardfield(1,4068, "ac");
...
quest::resetguardfields(1,4068);
}

sub EVENT_SPAWN
{
	quest::loadguardtype(1,4068);
}