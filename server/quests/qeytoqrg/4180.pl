...
if($text=~/status/i){
$hp = quest::getguardfield(1, 4180, "hp");
$mana = quest::getguardfield(1, 4180, "mana");
$hpregen = quest::getguardfield(1, 4180, "hpregen");
$manaregen = quest::getguardfield(1, 4180, "manaregen");
$levels = quest::getguardfield(1, 4180, "level");
$ac = quest::getguardfield(1, 4180, "ac");
...
quest::resetguardfields(1, 4180);
}

sub EVENT_SPAWN
{
	quest::loadguardtype(1, 4180);
}