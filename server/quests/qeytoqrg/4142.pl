...
if($text=~/status/i){
$hp = quest::getguardfield(1, 4142, "hp");
$mana = quest::getguardfield(1, 4142, "mana");
$hpregen = quest::getguardfield(1, 4142, "hpregen");
$manaregen = quest::getguardfield(1, 4142, "manaregen");
$levels = quest::getguardfield(1, 4142, "level");
$ac = quest::getguardfield(1, 4142, "ac");
...
quest::resetguardfields(1, 4142);
}

sub EVENT_SPAWN
{
	quest::loadguardtype(1, 4142);
}