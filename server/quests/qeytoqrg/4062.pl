...
if($text=~/status/i){
$hp = quest::getguardfield(1,4062, "hp");
$mana = quest::getguardfield(1,4062, "mana");
$hpregen = quest::getguardfield(1,4062, "hpregen");
$manaregen = quest::getguardfield(1,4062, "manaregen");
$levels = quest::getguardfield(1,4062, "level");
$ac = quest::getguardfield(1,4062, "ac");
...
quest::resetguardfields(1,4062);
}

sub EVENT_SPAWN
{
	quest::loadguardtype(1,4062);
}