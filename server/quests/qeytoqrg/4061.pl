...
if($text=~/status/i){
$hp = quest::getguardfield(1,4061, "hp");
$mana = quest::getguardfield(1,4061, "mana");
$hpregen = quest::getguardfield(1,4061, "hpregen");
$manaregen = quest::getguardfield(1,4061, "manaregen");
$levels = quest::getguardfield(1,4061, "level");
$ac = quest::getguardfield(1,4061, "ac");
...
quest::resetguardfields(1,4061);
}

sub EVENT_SPAWN
{
	quest::loadguardtype(1,4061);
}