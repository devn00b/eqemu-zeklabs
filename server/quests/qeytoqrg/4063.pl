...
if($text=~/status/i){
$hp = quest::getguardfield(1,4063, "hp");
$mana = quest::getguardfield(1,4063, "mana");
$hpregen = quest::getguardfield(1,4063, "hpregen");
$manaregen = quest::getguardfield(1,4063, "manaregen");
$levels = quest::getguardfield(1,4063, "level");
$ac = quest::getguardfield(1,4063, "ac");
...
quest::resetguardfields(1,4063);
}

sub EVENT_SPAWN
{
	quest::loadguardtype(1,4063);
}