...
quest::say("I can help you by levelling you or upping your skills.  Say level [1-$devmax] to have your character changed.");
...
{
quest::say("$resultLvl is out of range (1-$devmax)");
}
