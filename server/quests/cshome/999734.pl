...
sub EVENT_SAY {
  ...
  quest::say("There is a great evil coming $name, and only you can stop it. Before you do, your going to have to become more powerful. You need to get me $itemlink. With this item and some magical talismans I can then, with 
  some luck, grant you $itemlink2 which will help you stop the coming evil.");
  quest::say("");
  ...
  $qstlnk = quest::saylink("time");
quest::say("Good...Good. Now first you must bring me the 3 talismans of lesser powers ($itemlink4, $itemlink3, $itemlink2) and $itemlink. The talismans are found in Solb, and the vine is located deep inside Cazic 
Thule from The Avatar of Fear.");
quest::say(" ");
