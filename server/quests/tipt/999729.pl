...
##### ADDING IN BEASTLORD
        elsif (($class eq  'Beastlord') && ($class ne 'Rogue' && $class ne 'Monk' && $class ne 'Berserker' && $class ne 'Warrior' && $class ne 'Shadowknight' && $class ne 'Paladin' && $class ne 'Ranger' && $class ne 'Magician' && $class ne 'Necromancer' && $class ne 'Enchanter' && $class ne 'Wizard' && $class ne 'Bard' && $class ne 'Druid' && $class ne 'Shaman' && $class ne 'Cleric')) {
