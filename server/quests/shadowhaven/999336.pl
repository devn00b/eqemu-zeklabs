sub EVENT_SAY {
  if($text=~/hail/i) {
quest::say("If u got ears me want ears!  I want ears of all kinds! Give me TWO ears for a prize!");
}
}
...
else
{
	...
	quest::say("Mmmm excellent!! Take this and talk to my buddy Tizzl he can give you something useful for two of these tickets");
