...
sub EVENT_ITEM {
   if (plugin::check_handin(\%itemcount, 13365 => 1, 21964 => 1, 13364 => 1  )) { #High elf, Erudite, and Human meat(Used human parts instead)
      quest::say("MmmmMmm. This will make good meat pies. Here. A little coins for you.");
      quest::ding();
      quest::exp(1000);
