...
if ($random_result<10){
      quest::summonitem(10082);
#quest::say("rawr1 $random_result");
    }
    else {
#quest::say("rawr2 $random_result");
      quest::summonitem(quest::ChooseRandom(10080, 10081));
    }
quest::depop();  
