...
sub EVENT_ITEM {
  ...
  elsif (plugin::check_handin(\%itemcount, 30046 => 1)) {
    quest::emote("squints closely and then looks back at $name.");
    quest::say("This is not completed!  You have more work ahead of you $name!");
    quest::summonitem(30046);
  }
  else {
