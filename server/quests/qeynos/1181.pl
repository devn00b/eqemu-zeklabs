...
if($text=~/status/i){
$hp = quest::getguardfield(1,1181, "hp");
$mana = quest::getguardfield(1,1181, "mana");
$hpregen = quest::getguardfield(1,1181, "hpregen");
$manaregen = quest::getguardfield(1,1181, "manaregen");
$levels = quest::getguardfield(1,1181, "level");
$ac = quest::getguardfield(1,1181, "ac");
...
quest::resetguardfields(1,1181);
}

sub EVENT_SPAWN
{
	quest::loadguardtype(1,1181);
}