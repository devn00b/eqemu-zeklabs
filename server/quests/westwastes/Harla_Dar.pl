...
sub EVENT_SAY {
  if ($faction <= 4) {
    ...
    if ($text=~/son/i) {
      quest::say("Have you seen him? I must find him, he has been gone far to long! If you have harmed him, I will slay you and all of your
race! Tell me where he is!");
    }
  }
}
